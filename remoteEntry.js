import { a as __vitePreload } from './assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_react_mf_2_three_mf_1_drei__loadShare__.mjs-f1z_Gfkw.js';
...
function preloadAssets(remoteInfo, host, assets, useLinkPreload = true) {
	...
	if (host.options.inBrowser) {
		entryAssets.forEach((asset) => {
			...
			if (module) require_load$5.getRemoteEntry({
				origin: host,
				remoteInfo: moduleInfo,
				remoteEntryExports: module.remoteEntryExports
			});
			else require_load$5.getRemoteEntry({
				origin: host,
				remoteInfo: moduleInfo,
...
var helpers_default = {
	...
	utils: {
		...
		getRemoteInfo: require_load$4.getRemoteInfo
	}
};
...
var Module = class {
	...
	async getEntry() {
		...
		const remoteEntryExports = await require_load$3.getRemoteEntry({
			origin: this.host,
...
var SnapshotHandler = class {
	...
	async getManifestJson(manifestUrl, moduleInfo, extraOptions) {
		const getManifest = async () => {
			...
			try {
				let res = await this.loaderHook.lifecycle.fetch.emit(manifestUrl, {}, require_load$2.getRemoteInfo(moduleInfo));
...
const __mfResolveGlobalKey = "__mf_init__virtual:mf:__mfe_internal__k3_mf_2_ring__mf_v__runtimeInit__mf_v__.js__";
...
const __mfModuleCache = globalThis[__mfCacheGlobalKey];
  ...
  const mfName = "__mfe_internal__k3-ring";
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__k3_mf_2_ring-DVBTopHO.js'),true              ?[]:void 0))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-Bd_7rk2D.js'),true              ?[]:void 0))
  ...
  async function init(shared = {}, initScope = []) {
    ...
    if (__mfModuleCache.share["react"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__react__loadShare__.mjs-Cg0rfq73.js').then(n => n.R),true              ?[]:void 0);
...
if (__mfModuleCache.share["react-dom"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__react_mf_2_dom__loadShare__.mjs-6F4dlPkB.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["@emotion/cache"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_emotion_mf_1_cache__loadShare__.mjs-D_qBeFsO.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["@emotion/react"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_emotion_mf_1_react__loadShare__.mjs-DfArSKTg.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
        ...
        __mfModuleCache.share["@emotion/react"] = exportModule;
      }
if (__mfModuleCache.share["@emotion/styled"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_emotion_mf_1_styled__loadShare__.mjs-CTKGR522.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["@mui/material"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_mui_mf_1_material__loadShare__.mjs-HrW_Roe4.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["@mui/styled-engine"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_mui_mf_1_styled_mf_2_engine__loadShare__.mjs-B0xJGbBg.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["@react-three/drei"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_react_mf_2_three_mf_1_drei__loadShare__.mjs-f1z_Gfkw.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
        ...
        __mfModuleCache.share["@react-three/drei"] = exportModule;
      }
if (__mfModuleCache.share["@react-three/fiber"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_react_mf_2_three_mf_1_fiber__loadShare__.mjs-DAT0Jfly.js').then(n => n._),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
...
if (__mfModuleCache.share["three"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__three__loadShare__.mjs-bRXpUYHh.js').then(n => n.T),true              ?[]:void 0);
        const __mfNormalizeRuntimeShare = (mod) => {
            let current = mod;
            for (let i = 0; i < 5; i++) {
              const defaultExport = current?.default;
