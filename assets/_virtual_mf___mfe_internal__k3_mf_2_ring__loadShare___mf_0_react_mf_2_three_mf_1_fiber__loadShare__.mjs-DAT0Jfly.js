import { _ as __mf_165, a as __mf_52, b as __mf_277, c as __mf_389, d as __mf_328, e as __mf_408, f as __mf_315, g as __mf_250, h as __mf_255, i as __mf_330, j as __mf_252, k as __mf_396, l as __mf_251, m as __mf_29, n as __mf_54, o as __mf_188, p as __mf_232, q as __mf_0$2, r as __mf_397, s as __mf_398, t as __mf_51, T as THREE } from './_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__three__loadShare__.mjs-bRXpUYHh.js';
import { p as __mfDefaultExport$2, s as __mf_1$2, c as __mf_12$2, b as __mf_23$2, t as __mf_27$2, g as __mf_31, l as __mf_35, u as __mf_20$2, a as __mf_11$2, v as __moduleExports$1, f as __mf_34, q as __mf_28$2, r as __mf_38, _ as __mf_30, j as __mf_26$2, w as __mf_5$2, e as __mf_2$2, x as __mf_13$2, y as __mf_6$2 } from './_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__react__loadShare__.mjs-Cg0rfq73.js';
import { g as getDefaultExportFromCjs, _ as __mf_1$3, b as __mf_0$3 } from './_virtual_mf___mfe_internal__k3_mf_2_ring__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.mjs-fXKQsZNi.js';
 ...
 * LICENSE file in the root directory of this source tree.
 */
var React$1 = __mfDefaultExport$1;
function is$2(x, y) {
...
function useStoreWithEqualityFn(api, selector = identity, equalityFn) {
  ...
  __mfDefaultExport$2.useDebugValue(slice);
  return slice;
}
...
const a = /* @__PURE__ */ l(/* @__PURE__ */ __mf_11$2(null));
class m extends __mf_1$2 {
  render() {
    return /* @__PURE__ */ __mf_12$2(a.Provider, { value: this._reactInternals }, this.props.children);
  }
}
function c() {
  const e = __mf_23$2(a);
...
function h() {
  const e = c(), [t] = __mf_35(() => /* @__PURE__ */ new Map());
  t.clear();
  let r = e;
  for (; r; ) {
    const n = r.type;
    b(n) && n !== a && !t.has(n) && t.set(n, __mf_20$2(l(n))), r = r.return;
  }
  return t;
}
function x() {
  ...
  return __mf_31(
    () => Array.from(e.keys()).reduce(
      (t, r) => (n) => /* @__PURE__ */ __mf_12$2(t, null, /* @__PURE__ */ __mf_12$2(r.Provider, { ...n, value: e.get(r) })),
      (t) => /* @__PURE__ */ __mf_12$2(m, { ...t })
    ),
    [e]
  );
}
...
const act = __moduleExports$1.act;
const isOrthographicCamera = (def) => def && def.isOrthographicCamera;
const isRef = (obj) => obj && obj.hasOwnProperty("current");
const isColorRepresentation = (value) => value != null && (typeof value === "string" || typeof value === "number" || value.isColor);
const useIsomorphicLayoutEffect = /* @__PURE__ */ ((_window$document, _window$navigator) => typeof window !== "undefined" && (((_window$document = window.document) == null ? void 0 : _window$document.createElement) || ((_window$navigator = window.navigator) == null ? void 0 : _window$navigator.product) === "ReactNative"))() ? __mf_30 : __mf_26$2;
function useMutableCallback(fn) {
  const ref = __mf_34(fn);
...
function useBridge() {
  ...
  return __mf_31(() => ({
    ...
    const strict = !!i$1(fiber, true, (node) => node.type === __mf_5$2);
    const Root = strict ? __mf_5$2 : __mf_2$2;
    return /* @__PURE__ */ __mf_1$3(Root, {
      children: /* @__PURE__ */ __mf_1$3(ContextBridge, {
        children
      })
    });
  }, [fiber, ContextBridge]);
...
const ErrorBoundary = /* @__PURE__ */ ((_ErrorBoundary) => (_ErrorBoundary = class ErrorBoundary extends __mf_1$2 {
  constructor(...args) {
    super(...args);
    this.state = {
      error: false
...
function applyProps(object, props) {
  ...
  for (const prop in props) {
    ...
    if (target instanceof __mf_165 && value instanceof __mf_165) {
      target.mask = value.mask;
    } else if (target instanceof __mf_52 && isColorRepresentation(value)) {
      target.set(value);
      ...
      root[key].format === __mf_277 && root[key].type === __mf_389) {
        root[key].colorSpace = __mf_328;
      }
    }
  }
    ...
    if (intersections.length) {
      ...
      for (const hit of intersections) {
        ...
        if (state2) {
          ...
          const unprojectedPoint = new __mf_398(pointer.x, pointer.y, 0).unproject(camera);
...
const context = /* @__PURE__ */ __mf_11$2(null);
const createStore = (invalidate2, advance2) => {
  const rootStore = createWithEqualityFn((set, get) => {
    const position = new __mf_398();
    const defaultTarget = new __mf_398();
    const tempTarget = new __mf_398();
...
function useInstanceHandle(ref) {
  const instance = __mf_34(null);
  __mf_28$2(instance, () => ref.current.__r3f, [ref]);
  return instance;
}
function useStore() {
  const store = __mf_23$2(context);
...
function useGraph(object) {
  return __mf_31(() => buildGraph(object), [object]);
}
...
const reconciler = /* @__PURE__ */ createReconciler({
  ...
  HostTransitionContext: /* @__PURE__ */ __mf_11$2(null),
  ...
  return {
    async configure(props = {}) {
      ...
      if (!raycaster) state2.set({
        raycaster: raycaster = new __mf_315()
      });
      const {
        params,
        ...options
      ...
      if (!state2.camera || state2.camera === lastCamera && !is.equ(lastCamera, cameraOptions, shallowLoose)) {
        ...
        const camera = isCamera ? cameraOptions : orthographic ? new __mf_250(0, 0, 0, 0, 0.1, 1e3) : new __mf_255(75, 0, 0.1, 1e3);
        if (!isCamera) {
          camera.position.z = 5;
          if (cameraOptions) {
      ...
      if (gl.shadowMap) {
        ...
        if (is.boo(shadows)) {
          ...
          gl.shadowMap.type = (_types$shadows = types[shadows]) != null ? _types$shadows : __mf_252;
        } else if (is.obj(shadows)) {
          Object.assign(gl.shadowMap, shadows);
        }
        if (oldEnabled !== gl.shadowMap.enabled || oldType !== gl.shadowMap.type) gl.shadowMap.needsUpdate = true;
      }
      __mf_54.enabled = !legacy;
      if (!configured) {
        gl.outputColorSpace = linear ? __mf_188 : __mf_328;
        gl.toneMapping = flat ? __mf_232 : __mf_0$2;
      }
    ...
    render(children) {
      ...
      pending.then(() => {
        reconciler.updateContainer(/* @__PURE__ */ __mf_1$3(Provider, {
          store,
          children,
          onCreated,
          rootElement: canvas
...
function Provider({
  ...
  return /* @__PURE__ */ __mf_1$3(context.Provider, {
    value: store,
    children
  });
}
...
function createPortal(children, container, state2) {
  return /* @__PURE__ */ __mf_1$3(Portal, {
    children,
    container,
    state: state2
  });
...
function Portal({
  ...
  const [raycaster] = __mf_35(() => new __mf_315());
  const [pointer] = __mf_35(() => new __mf_397());
  const inject = useMutableCallback((rootState, injectState) => {
    let viewport = void 0;
    if (injectState.camera && size) {
      const camera = injectState.camera;
      viewport = rootState.viewport.getCurrentViewport(camera, new __mf_398(), size);
  ...
  return (
    ...
    /* @__PURE__ */ __mf_1$3(__mf_0$3, {
      children: reconciler.createPortal(/* @__PURE__ */ __mf_1$3(context.Provider, {
...
function g(n,t){let o;return (...i)=>{window.clearTimeout(o),o=window.setTimeout(()=>n(...i),t);}}function j({debounce:n,scroll:t,polyfill:o,offsetSize:i}={debounce:0,scroll:false,offsetSize:false}){const a=o||(typeof window=="undefined"?class{}:window.ResizeObserver);if(!a)throw new Error("This browser does not support ResizeObserver out of the box. See: https://github.com/react-spring/react-use-measure/#resize-observer-polyfills");const[c,h]=__mf_35({left:0,top:0,width:0,height:0,bottom:0,right:0,x:0,y:0}),e=__mf_34({element:null,scrollContainers:null,resizeObserver:null,lastBounds:c,orientationHandler:null}),d=n?typeof n=="number"?n:n.scroll:null,f=n?typeof n=="number"?n:n.resize:null,w=__mf_34(false);__mf_26$2(()=>(w.current=true,()=>void(w.current=false)));const[z,m,s]=__mf_31(()=>{const r=()=>{if(!e.current.element)return;const{left:y,top:C,width:H,height:O,bottom:S,right:x,x:B,y:R}=e.current.element.getBoundingClientRect(),l={left:y,top:C,width:H,height:O,bottom:S,right:x,x:B,y:R};e.current.element instanceof HTMLElement&&i&&(l.height=e.current.element.offsetHeight,l.width=e.current.element.offsetWidth),Object.freeze(l),w.current&&!D(e.current.lastBounds,l)&&h(e.current.lastBounds=l);};return [r,f?g(r,f):r,d?g(r,d):r]},[h,i,d,f]);function v(){e.current.scrollContainers&&(e.current.scrollContainers.forEach(r=>r.removeEventListener("scroll",s,true)),e.current.scrollContainers=null),e.current.resizeObserver&&(e.current.resizeObserver.disconnect(),e.current.resizeObserver=null),e.current.orientationHandler&&("orientation"in screen&&"removeEventListener"in screen.orientation?screen.orientation.removeEventListener("change",e.current.orientationHandler):"onorientationchange"in window&&window.removeEventListener("orientationchange",e.current.orientationHandler));}function b(){e.current.element&&(e.current.resizeObserver=new a(s),e.current.resizeObserver.observe(e.current.element),t&&e.current.scrollContainers&&e.current.scrollContainers.forEach(r=>r.addEventListener("scroll",s,{capture:true,passive:true})),e.current.orientationHandler=()=>{s();},"orientation"in screen&&"addEventListener"in screen.orientation?screen.orientation.addEventListener("change",e.current.orientationHandler):"onorientationchange"in window&&window.addEventListener("orientationchange",e.current.orientationHandler));}const L=r=>{!r||r===e.current.element||(v(),e.current.element=r,e.current.scrollContainers=E(r),b());};return X(s,!!t),W(m),__mf_26$2(()=>{v(),b();},[t,s,m]),__mf_26$2(()=>v,[]),[L,c,z]}function W(n){__mf_26$2(()=>{const t=n;return window.addEventListener("resize",t),()=>void window.removeEventListener("resize",t)},[n]);}function X(n,t){__mf_26$2(()=>{if(t){const o=n;return window.addEventListener("scroll",o,{capture:true,passive:true}),()=>void window.removeEventListener("scroll",o,true)}},[n,t]);}function E(n){const t=[];if(!n||n===document.body)return t;const{overflow:o,overflowX:i,overflowY:a}=window.getComputedStyle(n);return [o,i,a].some(c=>c==="auto"||c==="scroll")&&t.push(n),[...t,...E(n.parentElement)]}const k=["x","y","top","bottom","left","right","width","height"],D=(n,t)=>k.every(o=>n[o]===t[o]);
...
function CanvasImpl({
  ...
  const canvasRef = __mf_34(null);
  const divRef = __mf_34(null);
  __mf_28$2(ref, () => canvasRef.current);
  const handlePointerMissed = useMutableCallback(onPointerMissed);
  const [block, setBlock] = __mf_35(false);
  const [error, setError] = __mf_35(false);

  // Suspend this component if block is a promise (2nd run)
  if (block) throw block;
  // Throw exception outwards if anything within canvas throws
  if (error) throw error;
  const root = __mf_34(null);
  useIsomorphicLayoutEffect(() => {
    ...
    if (containerRect.width > 0 && containerRect.height > 0 && canvas) {
      ...
      async function run() {
        ...
        root.current.render( /*#__PURE__*/__mf_1$3(Bridge, {
          children: /*#__PURE__*/__mf_1$3(ErrorBoundary, {
            set: setError,
            children: /*#__PURE__*/__mf_1$3(__mf_6$2, {
              fallback: /*#__PURE__*/__mf_1$3(Block, {
                set: setBlock
              }),
  ...
  return /*#__PURE__*/__mf_1$3("div", {
    ...
    ...props,
    children: /*#__PURE__*/__mf_1$3("div", {
      ref: containerRef,
      style: {
        width: '100%',
        height: '100%'
      },
      children: /*#__PURE__*/__mf_1$3("canvas", {
        ref: canvasRef,
        style: {
          display: 'block'
        },
...
function Canvas(props) {
  return /*#__PURE__*/__mf_1$3(m, {
    children: /*#__PURE__*/__mf_1$3(CanvasImpl, {
      ...props
    })
  });
}
...
const __mfPrebuildExports = __mfPrebuildNamespace;
    const __mf_0$1 = __mfPrebuildExports["ReactThreeFiber"];
    const __mf_1$1 = __mfPrebuildExports["_roots"];
    const __mf_2$1 = __mfPrebuildExports["act"];
    const __mf_3$1 = __mfPrebuildExports["addAfterEffect"];
    const __mf_4$1 = __mfPrebuildExports["addEffect"];
    const __mf_5$1 = __mfPrebuildExports["addTail"];
    const __mf_6$1 = __mfPrebuildExports["advance"];
    const __mf_7$1 = __mfPrebuildExports["applyProps"];
    const __mf_8$1 = __mfPrebuildExports["buildGraph"];
    const __mf_9$1 = __mfPrebuildExports["context"];
    const __mf_10$1 = __mfPrebuildExports["createEvents"];
    const __mf_11$1 = __mfPrebuildExports["createPortal"];
    const __mf_12$1 = __mfPrebuildExports["createRoot"];
    const __mf_13$1 = __mfPrebuildExports["dispose"];
    const __mf_14$1 = __mfPrebuildExports["events"];
    const __mf_15$1 = __mfPrebuildExports["extend"];
    const __mf_16$1 = __mfPrebuildExports["flushGlobalEffects"];
    const __mf_17$1 = __mfPrebuildExports["flushSync"];
    const __mf_18$1 = __mfPrebuildExports["getRootState"];
    const __mf_19$1 = __mfPrebuildExports["invalidate"];
    const __mf_20$1 = __mfPrebuildExports["reconciler"];
    const __mf_21$1 = __mfPrebuildExports["unmountComponentAtNode"];
    const __mf_22$1 = __mfPrebuildExports["useFrame"];
    const __mf_23$1 = __mfPrebuildExports["useGraph"];
    const __mf_24$1 = __mfPrebuildExports["useInstanceHandle"];
    const __mf_25$1 = __mfPrebuildExports["useLoader"];
    const __mf_26$1 = __mfPrebuildExports["useStore"];
    const __mf_27$1 = __mfPrebuildExports["useThree"];
    const __mf_28$1 = __mfPrebuildExports["Canvas"];

const __mfLocalShare = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  Canvas: __mf_28$1,
  ReactThreeFiber: __mf_0$1,
  _roots: __mf_1$1,
  act: __mf_2$1,
  addAfterEffect: __mf_3$1,
  addEffect: __mf_4$1,
  addTail: __mf_5$1,
  advance: __mf_6$1,
  applyProps: __mf_7$1,
  buildGraph: __mf_8$1,
  context: __mf_9$1,
  createEvents: __mf_10$1,
  createPortal: __mf_11$1,
  createRoot: __mf_12$1,
  default: __mfPrebuildExports,
  dispose: __mf_13$1,
  events: __mf_14$1,
  extend: __mf_15$1,
  flushGlobalEffects: __mf_16$1,
  flushSync: __mf_17$1,
  getRootState: __mf_18$1,
  invalidate: __mf_19$1,
  reconciler: __mf_20$1,
  unmountComponentAtNode: __mf_21$1,
  useFrame: __mf_22$1,
  useGraph: __mf_23$1,
  useInstanceHandle: __mf_24$1,
  useLoader: __mf_25$1,
  useStore: __mf_26$1,
  useThree: __mf_27$1
}, Symbol.toStringTag, { value: 'Module' }));
...
const __mfModuleCache = globalThis[__mfCacheGlobalKey];
    ...
    let exportModule = __mfModuleCache.share["@react-three/fiber"];
    if (exportModule === undefined) {
      exportModule = __mfNormalizeShareModule(__mfLocalShare);
      __mfModuleCache.share["@react-three/fiber"] = exportModule;
    }
    ...
    const { ReactThreeFiber: __mf_0, _roots: __mf_1, act: __mf_2, addAfterEffect: __mf_3, addEffect: __mf_4, addTail: __mf_5, advance: __mf_6, applyProps: __mf_7, buildGraph: __mf_8, context: __mf_9, createEvents: __mf_10, createPortal: __mf_11, createRoot: __mf_12, dispose: __mf_13, events: __mf_14, extend: __mf_15, flushGlobalEffects: __mf_16, flushSync: __mf_17, getRootState: __mf_18, invalidate: __mf_19, reconciler: __mf_20, unmountComponentAtNode: __mf_21, useFrame: __mf_22, useGraph: __mf_23, useInstanceHandle: __mf_24, useLoader: __mf_25, useStore: __mf_26, useThree: __mf_27, Canvas: __mf_28 } = exportModule;
  
const __moduleExports = exportModule;

const _virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_react_mf_2_three_mf_1_fiber__loadShare__ = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  Canvas: __mf_28,
  ReactThreeFiber: __mf_0,
  _roots: __mf_1,
  act: __mf_2,
  addAfterEffect: __mf_3,
  addEffect: __mf_4,
  addTail: __mf_5,
  advance: __mf_6,
  applyProps: __mf_7,
  buildGraph: __mf_8,
  context: __mf_9,
  createEvents: __mf_10,
  createPortal: __mf_11,
  createRoot: __mf_12,
  default: __mfDefaultExport,
  dispose: __mf_13,
  events: __mf_14,
  extend: __mf_15,
  flushGlobalEffects: __mf_16,
  flushSync: __mf_17,
  getRootState: __mf_18,
  invalidate: __mf_19,
  reconciler: __mf_20,
  unmountComponentAtNode: __mf_21,
  useFrame: __mf_22,
  useGraph: __mf_23,
  useInstanceHandle: __mf_24,
  useLoader: __mf_25,
  useStore: __mf_26,
  useThree: __mf_27
}, [__moduleExports]);

export { _virtual_mf___mfe_internal__k3_mf_2_ring__loadShare___mf_0_react_mf_2_three_mf_1_fiber__loadShare__ as _, __mf_27 as a, __mf_22 as b, createStore$1 as c, __mf_9 as d, __mf_25 as e, clear as f, __mf_15 as g, __mf_7 as h, __mf_11 as i, __mf_24 as j, __mf_4 as k, __mf_3 as l, __mfLocalShare as m, preload as p, suspend as s, useSyncExternalStoreExports as u };
