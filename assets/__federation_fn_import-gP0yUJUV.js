...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DoKb58Ht.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-DU2-P0kt.js', import.meta.url).href),import:true},'@react-three/drei':{get:()=>()=>__federation_import(new URL('__federation_shared_@react-three/drei-B1DamgBc.js', import.meta.url).href),import:true},'@react-three/fiber':{get:()=>()=>__federation_import(new URL('__federation_shared_@react-three/fiber-dGWfYXMN.js', import.meta.url).href),import:true},'three':{get:()=>()=>__federation_import(new URL('__federation_shared_three-0yiyFbTj.js', import.meta.url).href),import:true},'three-stdlib':{get:()=>()=>__federation_import(new URL('__federation_shared_three-stdlib-BpkB9dsh.js', import.meta.url).href),import:true}};
