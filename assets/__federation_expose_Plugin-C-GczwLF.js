...
const Segment = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("mesh", { geometry: mergedGeometry, children: props.children });
};
const Ring = (props) => {
  const vGap = 4;
  const vWidth = 4 + vGap;
  ...
  shape2.lineTo(-0.08, ry - sink);
  shape2.lineTo(-0.08, -0.05 + sink);
  shape2.lineTo(gap, -0.05 + sink);
  const shape3 = new THREE.Shape();
  shape3.moveTo(-0.08, -0.05);
  shape3.splineThru([
    new THREE.Vector2(-0.08, -0.05),
    new THREE.Vector2(-0.16, -0.8 * ry),
    new THREE.Vector2(-0.16, 0.8 * ry),
    new THREE.Vector2(-0.08, ry)
  ]);
  shape3.lineTo(-0.08, -0.05);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Segment, { shape: shape1, radius: props.radius, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Segment, { shape: shape2, radius: props.radius, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "meshStandardMaterial",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Segment, { shape: shape3, radius: props.radius, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "meshStandardMaterial",
      {
        color: new THREE.Color(1, 0.866, 0.236),
        roughness: 0.1,
