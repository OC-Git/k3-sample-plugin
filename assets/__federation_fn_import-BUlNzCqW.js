...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-CC5G17d-.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BQiyK-_7.js', import.meta.url).href),import:true},'@react-three/drei':{get:()=>()=>__federation_import(new URL('__federation_shared_@react-three/drei-DLmQvctB.js', import.meta.url).href),import:true},'@react-three/fiber':{get:()=>()=>__federation_import(new URL('__federation_shared_@react-three/fiber-DrrI5Ev2.js', import.meta.url).href),import:true},'three':{get:()=>()=>__federation_import(new URL('__federation_shared_three-0yiyFbTj.js', import.meta.url).href),import:true},'three-stdlib':{get:()=>()=>__federation_import(new URL('__federation_shared_three-stdlib-6kdw7f9F.js', import.meta.url).href),import:true}};
